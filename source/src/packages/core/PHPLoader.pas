...
LoadPHPFunc(@zend_register_long_constant, 'zend_register_long_constant');
LoadPHPFunc(@zend_register_double_constant, 'zend_register_double_constant');
LoadPHPFunc(@zend_register_string_constant, 'zend_register_string_constant');
LoadPHPFunc(@zend_register_stringl_constant, 'zend_register_stringl_constant');
