...
uses Windows, Messages, SysUtils, Classes, Vcl.Dialogs, Vcl.Graphics,
  ...
  WideStrUtils, AnsiStrings, PHPCommons;
...
begin
  ...
  begin
    ...
    begin
     ...
     //zend_register_long_constant( PAnsiChar(ColorName), AnsiStrings.strlen(PAnsiChar(ColorName)) + 1, Colors[i].Value, CONST_PERSISTENT or CONST_CS, 0, TSRMLS_DÑ);
    end;
  end;
